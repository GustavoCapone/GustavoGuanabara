...
public class CalcularMedia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNumero = new com.toedter.components.JSpinField();
        ...
        setSize(new java.awt.Dimension(168, 287));
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        int n1 = txtNumero.getValue();
        if(n1 < 0){
            lblResultado.setText("<html>Numero NEGATIVO</html>");
        }
        else if(n1 % 2 == 0){
    ...
    private com.toedter.components.JSpinField txtNumero;
